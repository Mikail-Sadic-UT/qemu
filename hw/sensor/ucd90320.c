...
/* Fixed replies to the vendor-specific block-read commands. */
static const uint8_t ucd90320_device_id[] = "UCD90320";
static const uint8_t ucd90320_monitor_config[] = { 0x00 };
static const uint8_t ucd90320_mfr_status[] = { 0x00, 0x00, 0x00, 0x00 };
...
static uint8_t ucd90320_read_byte(PMBusDevice *pmdev)
{
    ...
    case UCD9000_DEVICE_ID:
        ucd90320_send_block(pmdev, ucd90320_device_id,
                            sizeof(ucd90320_device_id) - 1);
        pmbus_idle(pmdev);
        return 0;
    ...
    case UCD9000_MONITOR_CONFIG:
        ucd90320_send_block(pmdev, ucd90320_monitor_config,
                            sizeof(ucd90320_monitor_config));
        pmbus_idle(pmdev);
        return 0;
    case UCD9000_MFR_STATUS:
        ucd90320_send_block(pmdev, ucd90320_mfr_status,
                            sizeof(ucd90320_mfr_status));
        pmbus_idle(pmdev);
        return 0;
    default:

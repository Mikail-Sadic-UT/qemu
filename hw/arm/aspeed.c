...
static void aspeed_machine_init(MachineState *machine)
{
     ...
     * first IF_NONE drive to it as logical unit 0.  The controller and its
    ...
    if (object_resolve_path_component(OBJECT(bmc->soc), "ufs")) {
        ...
        if (ufs_dinfo) {
            ...
            /* The Huygens OpenBMC image is laid out for 512-byte sectors. */
            qdev_prop_set_uint32(ufs_lu, "logical-block-size", 512);
